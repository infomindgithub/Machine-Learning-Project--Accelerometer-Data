...
# Models Fitted: Multiple models are fitted to Data_Training. Then prediction accuracy is determined using the Data_validation dataset. The model with highest accuracy is applied to the test data set. Random Forest model, to see if it would have acceptable performance. I fit the model on Data_Training1, and instruct the "train" function to use 3-fold cross-validation to select optimal tuning parameters for the model.
